...
import com.bigdata.sparkmall.common.model.DataModel.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
...
object MockerOffline {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val sparkConf = new SparkConf().setAppName("MockerOffline").setMaster("local[*]")
