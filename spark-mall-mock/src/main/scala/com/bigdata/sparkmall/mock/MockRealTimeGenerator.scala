package com.bigdata.sparkmall.mock

import java.util.{Properties, Random}

import com.bigdata.sparkmall.common.model.DataModel.CityInfo
import com.bigdata.sparkmall.common.utils.ConfigurationUtil
...
object MockRealTimeGenerator {
  ...
  def generateMockData(): Array[String] = {
    ...
    for (i <- 0 to 50) {
      ...
      val adid = 1+random.nextInt(10)
      val userid = 1+random.nextInt(10)
  ...
  def main(args: Array[String]): Unit = {
    ...
    val broker: String = ConfigurationUtil.getValueByKey("kafka.broker.list")
    val topic =  "ads_log"
