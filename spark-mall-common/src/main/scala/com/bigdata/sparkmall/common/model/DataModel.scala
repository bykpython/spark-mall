package com.bigdata.sparkmall.common.model
...
case class CityInfo (city_id:Long,
  ...
  case class CategoryTop10(taskId:String, category_id: String, click_count:Long, order_count:Long, pay_count:Long){}

  case class AdsLog(timestamp:String, province:String, city :String, userid:String,  adid:String)
}
